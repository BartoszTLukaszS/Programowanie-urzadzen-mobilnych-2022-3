...
\begin{table}[h!]
	...
	\begin{tblr}{
		...
		Grupa:      & IS-2(s)P1  & Nr raportu: & 8 & Data: & 20.12.2022 \\
...
\textit{Liczenie kroków przez krokomierz tylko podczas treningu.} \\
\textit{Ustawienia - możliwość wpisania loginu, hasła, wieku i wagi użytkownika.}
...
\textit{Dodanie opcji powiadomień o treningu.} \\
