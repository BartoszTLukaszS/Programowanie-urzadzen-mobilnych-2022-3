...
\begin{table}[h!]
	...
	\begin{tblr}{
		...
		Grupa:      & IS-2(s)P1  & Nr raportu: & 4 & Data: & 15.11.2022 \\
...
\textit{Zapis treningów do bazy danych SQLite i wyświetlanie ich w zakładce Historia.} \\
...
\textit{Treningi zapisywały się w zakładce Historia w kolejności od najstarszego do najnowszego.} \\
