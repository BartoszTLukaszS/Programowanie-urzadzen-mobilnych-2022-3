...
\begin{table}[h!]
	...
	\begin{tblr}{
		...
		Grupa:      & IS-2(s)P1  & Nr raportu: & 6 & Data: & 29.11.2022 \\
...
\textit{Dodanie ekranu powitalnego.}

\section{Niewykonane zadania}

\textit{Działanie krokomierza w tle.}

\section{Napotkane problemy}

\section{Zadania na kolejny tydzień}

\textit{Implementacja działania krokomierza w tle.} \\
\textit{Poprawa i uzupełnienie dokumentacji.} \\
