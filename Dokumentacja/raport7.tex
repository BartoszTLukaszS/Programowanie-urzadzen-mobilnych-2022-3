...
\begin{table}[h!]
	...
	\begin{tblr}{
		...
		Grupa:      & IS-2(s)P1  & Nr raportu: & 7 & Data: & 13.12.2022 \\
...
\textit{Dodanie możliwości działania krokomierza w tle.} \\
\textit{Poprawa dokładności mierzenia kroków przez krokomierz - liczenie dopiero po wykonaniu kilku kroków w określonym czasie.} \\
\textit{Dodanie splash screen.}

\section{Niewykonane zadania}

\section{Napotkane problemy}

\textit{Krokomierz nie działa w tle dla Android API mniejszych niż 31.} \\

\section{Zadania na kolejny tydzień}

\textit{Poprawa i uzupełnienie dokumentacji.} \\
\textit{Dodanie opcji do wyboru w panelu Ustawienia.}
